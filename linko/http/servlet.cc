...
int32_t FunctionServlet::handle(linko::http::HttpRequest::ptr request
...
int32_t ServletDispatch::handle(linko::http::HttpRequest::ptr request
        , linko::http::HttpResponse::ptr response
        , linko::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(linko::http::HttpRequest::ptr request
        , linko::http::HttpResponse::ptr response
        , linko::http::HttpSession::ptr session) {
    static const std::string& RSP_BODY = "<html><head><title>404 Not Found"
        "</title></head><body><center><h1>404 Not Found</h1></center>"
        "<hr><center>linko/1.0.0</center></body></html>";

    response->setStatus(linko::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "linko/1.0.0");
